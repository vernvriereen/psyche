    ...
    <div className="w-full h-full relative" ref={containerEl}>
      ...
      >
        <Globe
          ...
          arcsData={arcs}
          arcStartLat={((n: { from: GeolocatedNode; to: GeolocatedNode }) => n.from.latitude) as (n: object) => number}
          arcStartLng={((n: { from: GeolocatedNode; to: GeolocatedNode }) => n.from.longitude) as (n: object) => number}
