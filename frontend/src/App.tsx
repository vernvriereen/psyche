			...
			{fading && (
				...
				>
					...
					<div className="text-9xl font-eva text">
						<TextStretcher className="w-[10vw] h-[5vh] pt-1">
							NOUS
						</TextStretcher>
						<TextStretcher className="w-[20vw] h-[5vh] pt-1">
							PSYCHE
						</TextStretcher>
	...
	return (
		<div className="font-black h-screen w-screen p-4 text-primary flex flex-col animate-fadeIn">
			...
			<p className="text-plain text-lg font-thin font-eva">
				Psyche is a distributed training framework. It interconnects globally
				distributed compute and trains state-of-the-art AI models at breakneck
				speeds. Psyche is powered by{" "}
