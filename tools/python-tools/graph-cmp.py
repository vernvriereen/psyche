...
def process_csv(csv_path):
    ...
    if None in data_values.values():
        print(
            "Warning: Some filenames did not match the expected pattern and were skipped."
        )
...
def main():
    ...
    parser.add_argument(
        "csv_file", type=str, help="Path to the CSV comparison matrix file."
    )
    parser.add_argument(
        "--suffix",
        type=str,
        default="_cmp_distribution.png",
